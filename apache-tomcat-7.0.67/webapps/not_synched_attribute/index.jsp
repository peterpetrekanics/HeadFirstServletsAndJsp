...
<title>TwoServletsInteracting1</title>
</head>
<body>
...
This web app shows the incorrect way of handling the attributes: <br>
servlet1 is reading the "myProgress" attribute, but servlet2 keeps changing it. <br>
The correct way to handle this would be to wait until servlet2 changed the attribute to <br>
